...
contract BoneToken is ERC20Permit, Ownable {

    constructor() ERC20("BoneToken", "BONE") ERC20Permit("BoneToken")
    {

    }

    uint256 constant private _maxTotalSupply = 13666000e18; // 13,666,000 max bones
    ...
    */
    ...
    function delegateBySig(address delegatee, uint nonce, uint expiry, uint8 v, bytes32 r, bytes32 s ) external {
        ...
        require(nonce == _useNonce(signatory), "BONE::delegateBySig: invalid nonce");
        require(block.timestamp <= expiry, "BONE::delegateBySig: signature expired");
